...
function -report-start-time() {
  ...
  if [ $ZSH_START_TIME ]; then
    ...
    export RPROMPT="%F{cyan}%{$__SingularisArt[ITALIC_ON]%}${ELAPSED}%{$__SingularisArt[ITALIC_OFF]%}%f $RPROMPT_BASE"
...
LOCAL_RC=$HOME/.config/zsh/.zshrc.local
