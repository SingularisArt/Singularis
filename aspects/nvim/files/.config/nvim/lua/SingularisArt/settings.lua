...
M.load = function()
  ...
  local default_options = {
    ...
    foldtext = "v:lua.SingularisArt.foldtext()", -- nice folding style
    ...
    directory = config .. "/swap", -- setting swap directory: (~/.config/nvim/swap)
    undodir = config .. "/undo", -- setting undo directory: (~/.config/nvim/undo)
    backupdir = config .. "/backup", -- setting backup directory: (~/.config/nvim/backup)
  }
